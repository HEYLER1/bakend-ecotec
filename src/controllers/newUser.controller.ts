...
export const newUser = async (req: Request, res: Response) => {
    try {
        ...
        const existingUserByDNI = await Usuario.findOne({ where: { dni: dni } });
        ...
        if (error.name === 'SequelizeUniqueConstraintError') {
            ...
            if (uniqueField === 'email') fieldName = 'email';
            else if (uniqueField === 'usuario') fieldName = 'nombre de usuario';
            else if (uniqueField === 'dni') fieldName = 'DNI';
